...
InstallTalkChineseTrad=You have installed another version of EaseUS Data Recovery Wizard, please uninstall it to continue. Uninstall it now?                    
EaseusComfirmContentChineseTrad=To prevent further data loss, please don't install on the drive you want to recover data from.   
EaseusConfirmInstallChineseTrad=Confirm Install Location   
EaseusInstallSuccessChineseTrad=Installation was successful   
EaseusRegisterInfoChineseTrad=Setup has finished installing EaseUS Data Recovery Wizard 9.0 on your computer.     
EaseusLaunchChineseTrad=Launch EaseUS Data Recovery Wizard           
EaseusParticipateChineseTrad=Participate in the Customer Experience Improvement Program     
SetupIsrunningChineseTrad=EaseUS Data Recovery Wizard setup is running         
ButtonFinishTitleChineseTrad=Finish      
ButtonInstallTitleChineseTrad=Install     
...
EaseusRun=Run EaseUS Data Recovery Wizard
EaseusHelp=EaseUS Data Recovery Wizard Help
EaseusHelpComment=Guide you to use EaseUS Data Recovery Wizard
EaseusUninstallComment=Uninstall EaseUS Data Recovery Wizard 9.0
LanguageType=ChineseTrad
LicenseAccepted = Accept
Confirm = Confirm
