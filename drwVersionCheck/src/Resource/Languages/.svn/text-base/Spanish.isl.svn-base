...
InstallTalkSpanish=Ha instalado otra versión de EaseUS Data Recovery Wizard, por favor desinstálelo para continuar. ¿Quiere desinstalarlo ahora?                    
EaseusComfirmContentSpanish=Para evitar una mayor pérdida de datos, por favor, no lo instale en el disco duro donde desea recuperar los datos.  
EaseusConfirmInstallSpanish=Confirmar la Localización de Instalación   
EaseusInstallSuccessSpanish=Instalación exitosa   
EaseusRegisterInfoSpanish=EaseUS Data Recovery Wizard 9.0 se ha instalado exitosamente en su computadora.     
EaseusLaunchSpanish=Funcionar EaseUS Data Recovery Wizard           
EaseusParticipateSpanish=Participar en el Programa para la Mejora de la Experiencia del Usuario     
SetupIsrunningSpanish=El programa de instalación de EaseUS Data Recovery Wizard est?funcionando         
ButtonFinishTitleSpanish=Terminar      
ButtonInstallTitleSpanish=Instalar     
...
EaseusRun=Funcionar EaseUS Data Recovery Wizard
EaseusHelp=Ayuda de EaseUS Data Recovery Wizard
EaseusHelpComment=Le ayuda a utilizar EaseUS Data Recovery Wizard
EaseusUninstallComment=Desinstalar EaseUS Data Recovery Wizard 9.0
LanguageType=Spanish
LicenseAccepted = Aceptar
Confirm = Confirmar
