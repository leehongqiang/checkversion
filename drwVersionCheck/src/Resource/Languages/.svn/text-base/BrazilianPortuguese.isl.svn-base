...
;Ìí¼ÓµÄ¶àÓïÑÔ·­Òë
InstallTalkBrPortuguese=Você já instalou uma outra versão do EASEUS Data Recovery Wizard, desinstale-o para continuar. Desinstale-lo agora?                   
EaseusComfirmContentBrPortuguese=Para evitar perder mais dados, por favor, não instale no disco rígido onde deseja recuperar os dados.   
EaseusConfirmInstallBrPortuguese=Confirme o local de instalação   
EaseusInstallSuccessBrPortuguese=A instalação foi bem sucedida   
EaseusRegisterInfoBrPortuguese=O EASEUS Data Recovery Wizard 9.0 está bem instalado no seu computador.    
EaseusLaunchBrPortuguese=Execute o EaseUS Data Recovery Wizard           
EaseusParticipateBrPortuguese=Participar do Programa de Aperfeiçoamento da Experiência do Cliente    
SetupIsrunningBrPortuguese=O programa de instalação do EASEUS Data Recovery Wizard está executando.         
ButtonFinishTitleBrPortuguese=Acabar      
ButtonInstallTitleBrPortuguese=Instalar     
...
EaseusRun=Execute EaseUS Data Recovery Wizard
EaseusHelp=EaseUS Data Recovery Wizard Ajuda
EaseusHelpComment=Orientá-lo a utilizar o EASEUS Data Recovery Wizard
EaseusUninstallComment=Desinstale EASEUS Data Recovery Wizard 9.0
LanguageType=BrazilianPortuguese
LicenseAccepted = Aceitar
Confirm = Confirmar
