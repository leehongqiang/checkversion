...
SelectTasksLabel2=Wählen Sie die zusätzlichen Aufgaben aus, die das Setup während der Installation von [name] ausführen soll, und klicken Sie danach auf "installieren".
...
InstallTalkDeutsch=Es ist bereits eine andere Version von EaseUS Data Recovery Wizard installiert.Bitte deinstallieren um fortzufahren. Jetzt deinstallieren?                   
EaseusComfirmContentDeutsch=Bitte nicht auf das Laufwerk installieren, das Sie Daten wiederherstellen wollen, um weiteren Datenverlust zu vermeiden.   
EaseusConfirmInstallDeutsch=Installationsziel bestätigen   
EaseusInstallSuccessDeutsch=Installation erfolgreich durchgeführt   
EaseusRegisterInfoDeutsch=Bitte registrieren Sie sich um die neusten Produktinformationen zu erhalten (Neuigkeiten, Tipps und Werbegeschenke).     
EaseusLaunchDeutsch=EaseUS Data Recovery Wizard starten           
EaseusParticipateDeutsch=Beteiligen Sie sich an dem Kundenerlebnis-Verbesserungsprogramm     
SetupIsrunningDeutsch=EaseUS Data Recovery Wizard setup läuft bereits         
ButtonFinishTitleDeutsch=Fertigstellen      
ButtonInstallTitleDeutsch=Installieren     
...
EaseusRun=EaseUS Data Recovery Wizard ausführen
EaseusHelp=EaseUS Data Recovery Wizard Hilfe
EaseusHelpComment=Handbuch zur Nutzung des EaseUS Data Recovery Wizards
EaseusUninstallComment=Deinstallieren EaseUS Data Recovery Wizard 9.0
LanguageType=Deutsch
LicenseAccepted =Akzeptieren
Confirm = Bestätigen
