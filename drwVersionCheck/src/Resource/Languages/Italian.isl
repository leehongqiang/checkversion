...
ErrorCloseApplications=L'installazione non ?riuscita a chiudere automaticamente tutte le applicazioni.†Si raccomanda di chiudere†tutte le applicazioni che usano file che devono essere aggiornati†durante l'installazione prima di proseguire.
...
InstallTalkItalian=?stata installata un'altra versione di Eas eUS Data Recovery Wizard, si prega di disinstallarlo per continuare. Disinstallare ora?                 
EaseusComfirmContentItalian=Per evitare ulteriori perdite di dati, si prega di non installare sul disco che si desidera ripristinare i dati.  
EaseusConfirmInstallItalian=Conferma Percorso di installazione   
EaseusInstallSuccessItalian=L'installazione ?stata eseguita correttamente   
EaseusRegisterInfoItalian=Setup ha completato l'installazione EaseUS Data Recovery Wizard 9.5 sul computer.   
EaseusLaunchItalian=Avviare EaseUS Data Recovery Wizard          
EaseusParticipateItalian=Partecipa al programma di Analisi utilizzo software     
SetupIsrunningItalian=Installazione del EaseUS Data Recovery Wizard ?in esecuzione         
ButtonFinishTitleItalian=Completa      
ButtonInstallTitleItalian=Installare     
...
EaseusRun=Eseguire EaseUS Data Recovery Wizard
EaseusHelp=Aiuto di EaseUS Data Recovery Wizard
EaseusHelpComment=Vi Guida per utilizzare EaseUS Data Recovery Wizard
EaseusUninstallComment=Disinstallare EaseUS Data Recovery Wizard 9.0
LanguageType=Italian
LicenseAccepted = Accttare
Confirm = Conferma
