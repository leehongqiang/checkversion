...
InstallTalkChinese=You have installed another version of EaseUS Data Recovery Wizard, please uninstall it to continue. Uninstall it now?                    
EaseusComfirmContentChinese=To prevent further data loss, please don't install on the drive you want to recover data from.   
EaseusConfirmInstallChinese=Confirm Install Location   
EaseusInstallSuccessChinese=Installation was successful   
EaseusRegisterInfoChinese=Setup has finished installing EaseUS Data Recovery Wizard 9.0 on your computer.     
EaseusLaunchChinese=Launch EaseUS Data Recovery Wizard           
EaseusParticipateChinese=Participate in the Customer Experience Improvement Program     
SetupIsrunningChinese=EaseUS Data Recovery Wizard setup is running         
ButtonFinishTitleChinese=Finish      
ButtonInstallTitleChinese=Install     
...
EaseusUninstallComment=Uninstall EaseUS Data Recovery Wizard .0
