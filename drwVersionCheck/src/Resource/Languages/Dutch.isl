...
InstallTalkDutch=You have installed another version of EaseUS Data Recovery Wizard, please uninstall it to continue. Uninstall it now?                    
EaseusComfirmContentDutch=To prevent further data loss, please don't install on the drive you want to recover data from.   
EaseusConfirmInstallDutch=Confirm Install Location   
EaseusInstallSuccessDutch=Installation was successful   
EaseusRegisterInfoDutch=Setup has finished installing EaseUS Data Recovery Wizard 9.0 on your computer.     
EaseusLaunchDutch=Launch EaseUS Data Recovery Wizard           
EaseusParticipateDutch=Participate in the Customer Experience Improvement Program     
SetupIsrunningDutch=EaseUS Data Recovery Wizard setup is running         
ButtonFinishTitleDutch=Finish      
ButtonInstallTitleDutch=Install     
